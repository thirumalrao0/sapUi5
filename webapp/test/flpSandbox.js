		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Crud",
									"targetURL": "#projectcrudop-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectcrudop-display": {
								"semanticObject": "projectcrudop",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectcrudop",
									"url": sap.ui.require.toUrl("projectcrudop")
								}
							}
						}
					}
